...
const LogDecodedInputDataTable = ({ data, isLoading }: Props) => {
  ...
  return (
    ...
    >
      <HeaderItem isLoading={ isLoading }>{ t('logDecodedInputDataTable.name') }</HeaderItem>
      <HeaderItem isLoading={ isLoading }>{ t('logDecodedInputDataTable.type') }</HeaderItem>
      { hasIndexed && <HeaderItem isLoading={ isLoading }>{ t('logDecodedInputDataTable.indexed') }</HeaderItem> }
      <HeaderItem isLoading={ isLoading }>{ t('logDecodedInputDataTable.data') }</HeaderItem>
      { data.map((item) => {
